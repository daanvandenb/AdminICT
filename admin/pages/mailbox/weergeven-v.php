...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
				...
				$result = mysqli_query($db,"SELECT * FROM feedback WHERE id='" . $_POST["users"][$i] . "'");
        ...
        <div class="col-md-6">
            <div class="card card-info">
              <div class="card-header">
                ...
                <h3 class="card-title"><span class="left"><?php echo $rij[$i]['naam']; ?>  <?php echo $rij[$i]['achternaam']; ?> </span><span class="right"><?php echo $rij[$i]['id']; ?></span></h3>
              </div>
              <div class="card-body">
                <!-- Date dd/mm/yyyy -->
